...
type Fn_ITextPredictionGenerator2_get_InputScope* = proc(self: pointer, value: ptr int32): HRESULT {.abi.}
const Slot_ITextPredictionGenerator2_put_InputScope* = 9
type Fn_ITextPredictionGenerator2_put_InputScope* = proc(self: pointer, a1: int32): HRESULT {.abi.}
